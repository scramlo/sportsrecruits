    ...
    <Transition name="fade" :appear="true" v-if="!loading && athlete">
        <div class="flex gap-4">
            ...
            <div class="flex items-center h-full">
                <div class="bg-gray-200 rounded-full flex justify-center items-center text-3xl overflow-hidden h-32 w-32">
            ...
            <div class="grid grid-cols-2 gap-1">
                <!-- row 1 player name -->
                <div class="col-span-2 text-sky-500 text-xl font-bold">{{ athlete.name }}</div>
